# Demetri Sebastian López

AI/ML engineer building multimodal models, agentic systems, and the full-stack tools needed to evaluate and use them.

I work primarily with Python, PyTorch, Transformers, FastAPI, Next.js, and TypeScript. My recent projects focus on goal-planning systems, multimodal question answering, generative graphics, geospatial imagery, and tool-using agents.
...
- Multimodal model adaptation and evaluation
